...
void DeformationGraph::setPosesSeq(std::vector<unsigned long long int> * poseTimeMap, const std::vector<Eigen::Matrix4f> & poses)
{
    ...
    for(unsigned int i = 0; i < poses.size(); i++)
    {
        ...
        {
            imid = (imin + imax) / 2;
            // std::cout << " before imid : " << imid << "   ----   value : " << sampledGraphTimes[imid] << std::endl;
            if (sampledGraphTimes[imid] < poseTime)
            {
                // std::cout << "  <  poseTime" << std::endl;
                // std::cout << " sampledGraphTimes[imid] : " << sampledGraphTimes[imid] << std::endl;
                // std::cout << " imid : " << imid << std::endl;
        ...
        // std::cout << " sampledGraphTimes :  " << sampledGraphTimes.size() << ", poseTime : " << poseTime << std::endl;
        // std::cout << " foundIndex : " << foundIndex << " ,  imin  : " << imin << " , imid : " << imid << ",  imax : " << imid << std::endl;
        ...
        // std::cout << " nearNodes : " << nearNodes.size() << std::endl;
        ...
        // {
            // std::cout << "first : " << nearNodes.at(0).first << std::endl;
            // std::cout <<"second : " << nearNodes.at(0).second << std::endl;
            // std::cout << " nemap node : " << newMap.at(0).node << std::endl;
            // std::cout << " nemap weight : " << newMap.at(0).weight << std::endl;
            // int kb;
            // std::cin>>kb;
...
void DeformationGraph::weightVerticesSeq(std::vector<unsigned long long int> * vertexTimeMap)
{
    ...
    // std::cout << "sourceVertices : " << sourceVertices->size() << std::endl;
