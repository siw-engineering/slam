...
: indexProgram(loadProgramFromFile("index_map.vert", "index_map.frag", "/home/developer/work/git_push/new/slam/src/model/shaders/")),
  ...
  normalRadTexture(width * IndexMap::FACTOR,
                   height * IndexMap::FACTOR,
                   GL_RGBA32F, GL_LUMINANCE, GL_FLOAT),
  // drawDepthProgram(loadProgramFromFile("empty.vert", "visualise_textures.frag", "quad.geom", "/home/developer/work/git_push/new/slam/src/model/shaders/")),
  ...
  drawTexture(width,
              ...
              GL_UNSIGNED_BYTE,
              false),
  depthProgram(loadProgramFromFile("splat.vert", "depth_splat.frag", "/home/developer/work/git_push/new/slam/src/model/shaders/")),
  ...
  depthTexture(width,
               ...
               false,
               true),
  combinedProgram(loadProgramFromFile("splat.vert", "combo_splat.frag", "/home/developer/work/git_push/new/slam/src/model/shaders/")),
