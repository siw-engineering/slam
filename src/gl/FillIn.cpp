...
FillIn::FillIn(int width, int height, CameraModel intr)
 : imageTexture(width,
   ...
   normalTexture(width,
                 ...
                 false,
                 true),
   imageProgram(loadProgramFromFile("empty.vert", "fill_rgb.frag", "quad.geom", "/home/developer/work/git_push/new/slam/src/gl/shaders/")),
   imageRenderBuffer(width, height),
   vertexProgram(loadProgramFromFile("empty.vert", "fill_vertex.frag", "quad.geom", "/home/developer/work/git_push/new/slam/src/gl/shaders/")),
   vertexRenderBuffer(width, height),
   normalProgram(loadProgramFromFile("empty.vert", "fill_normal.frag", "quad.geom", "/home/developer/work/git_push/new/slam/src/gl/shaders/")),
