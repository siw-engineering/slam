...
static inline std::shared_ptr<Shader> loadProgramGeomFromFile(const std::string& vertex_shader_file,
  ...
  program->AddShaderFromFile(pangolin::GlSlVertexShader, "/home/developer/work/shader_version/ef/slam/src/shaders/" +  vertex_shader_file, {},
                             {"/home/developer/work/shader_version/ef/slam/src/shaders/"});
  program->AddShaderFromFile(pangolin::GlSlGeometryShader, "/home/developer/work/shader_version/ef/slam/src/shaders/" + geometry_shader_file, {},
                             {"/home/developer/work/shader_version/ef/slam/src/shaders/"});
  program->Link();
...
static inline std::shared_ptr<Shader> loadProgramFromFile(const std::string& vertex_shader_file, const std::string& fragment_shader_file) {
  ...
  program->AddShaderFromFile(pangolin::GlSlVertexShader, "/home/developer/work/shader_version/ef/slam/src/shaders/" + vertex_shader_file,  {},
                             {"/home/developer/work/shader_version/ef/slam/src/shaders/"});
  program->AddShaderFromFile(pangolin::GlSlFragmentShader, "/home/developer/work/shader_version/ef/slam/src/shaders/" + fragment_shader_file, {},
                             {"/home/developer/work/shader_version/ef/slam/src/shaders/"});
  program->Link();
