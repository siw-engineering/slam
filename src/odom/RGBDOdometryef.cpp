...
#include "RGBDOdometryef.h"

RGBDOdometryef::RGBDOdometryef(int width,
                           int height,
...
RGBDOdometryef::~RGBDOdometryef()
{

}

void RGBDOdometryef::initICP(GPUTexture * filteredDepth, const float depthCutoff)
{
    cudaArray * textPtr;
...
void RGBDOdometryef::initICP(GPUTexture * predictedVertices, GPUTexture * predictedNormals, const float depthCutoff)
{
    cudaArray * textPtr;
...
void RGBDOdometryef::initICPModel(GPUTexture * predictedVertices,
...
void RGBDOdometryef::populateRGBDData(GPUTexture * rgb,
...
void RGBDOdometryef::initRGBModel(GPUTexture * rgb)
{
...
void RGBDOdometryef::initRGB(GPUTexture * rgb)
{
...
void RGBDOdometryef::initFirstRGB(GPUTexture * rgb)
{
    cudaArray * textPtr;
...
void RGBDOdometryef::getIncrementalTransformation(Eigen::Vector3f & trans,
...
Eigen::MatrixXd RGBDOdometryef::getCovariance()
{
